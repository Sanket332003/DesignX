  ...
  <body>
    <nav>
        ...
        <ul class="ul">
            ...
            <li><a href="additems.php" >AddItems</a></li>
            <li><a href="alluser.php">AllUsers</a></li>
            
            <li><a href="admindetail.php"class="active" id="active"><i class="fas fa-user"></i></a></li> -->
            <?php
             $id =  $_GET['id'];
  ...
  <div class="container">
    <div class="screen">
      <div class="screen-header">
           DesignX  DesignX  DesignX  DesignX  DesignX  DesignX  DesignX  DesignX  DesignX  DesignX  DesignX  
      </div>
